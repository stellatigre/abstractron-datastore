...
var usersResources = require("./usersResources.js");
...
swagger.addModels(models)
  .addGet(usersResources.findAll)
  .addGet(usersResources.findById);
  /*
  .addGet(usersResources.findById)
  .addPost(usersResources.addPet)
  .addPut(usersResources.updatePet)
  .addDelete(usersResources.deletePet);
  */

// Configures the app's base path and api version.
swagger.configure("http://devnode.vmception.com:8002/", "0.1");
